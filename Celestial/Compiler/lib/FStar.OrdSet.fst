...
let size_union2 #a #f s k = admit ()

let size_union3 #a #f s k = admit ()

(**********)

let non_zero_size_choose (#a:eqtype) #f s = ()
let choose_upd_det (#a:eqtype) #f s x = admit ()
let choose_upd_det2 (#a:eqtype) #f s x = admit ()
let del_union_choose (#a:eqtype) #f s x = admit ()
