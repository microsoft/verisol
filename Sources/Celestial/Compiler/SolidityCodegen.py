...
class SolidityCodegen:
    ...
    def enterProgram(self):
        ...
        if self.verificationMode == "VeriSol":
                self.writeToSolidity("\nimport \"./lib/VeriSolContracts.sol\";")  
                #TODO: What's the global location of VeriSol lib, else we need to write the library like SafeArith each time.
