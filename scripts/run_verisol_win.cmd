...
dotnet %VERISOL_ROOT_DIR%\Sources\SolToBoogie\bin\Debug\netcoreapp2.2\SolToBoogie.dll %1.sol %VERISOL_SOLC_DIR% out.bpl %5 %inlineArg%
@echo off
...
if [%4] EQU [proof] (
    ...
    echo Running Corral ...
    @echo on
    REM %BINARYDEPENDENCIES%\Corral\corral.exe /recursionBound:%3 /k:1 /main:%methodprefix%%2 /tryCTrace out.bpl  /printDataValues:1 > corral.txt
